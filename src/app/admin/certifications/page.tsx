...
export default async function AdminCertificationsPage() {
  ...
  const [{ data: certifications }, { data: siteContent }] =
    await Promise.all([
      supabase
        .from("certifications")
        .select(
        ...
        <div className="mt-8 flex flex-wrap items-end justify-between gap-6">
          <div>
            ...
            <p className="mt-4 max-w-2xl text-white/50">
              Everything here controls the Certifications section shown on your
              public website.
            </p>
          </div>
          ...
          <CertificationsManager
            ...
            initialSectionContent={{
              certifications_label:
                siteContent?.certifications_label ?? "",
              certifications_heading:
                siteContent?.certifications_heading ?? "",
