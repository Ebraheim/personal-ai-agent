...
export default async function AdminEducationPage() {
  ...
  const [{ data: education }, { data: profile }] = await Promise.all([
    supabase
      .from("education")
      .select("id, institution, degree, field, start_date, end_date, description, display_order, is_visible")
      .eq("user_id", user.id)
        ...
        <div className="mt-8 flex flex-wrap items-end justify-between gap-6">
          <div>
            ...
            <p className="mt-4 max-w-2xl text-white/50">
              Manage the education shown on your public website.
            </p>
          </div>
